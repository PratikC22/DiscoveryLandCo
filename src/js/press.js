window.addEventListener('DOMContentLoaded', function () {
    ...
    let contextArray = [
        ...
        { text2: ` Golf Real Estate Roars Back as Vacation Homes Boom in Pandemic `, author2: ` Bloomberg | September, 2021 ` },
        { text3: ` Brexit drives British millionaires to Portugal for tax and EU perks - but it's about to get complicated `, author3: ` Telegraph UK |  August 20, 2021 ` },
        { text4: ` This Property Company Ups the Ante with Luxury and Sustainability `, author4: ` Sunset Magazine | August 13 2021 ` }
        ],
        [{ text1: ` Where Sun, Sand and Splendor Are Still to Be Discovered `, author1: ` New York Times | June 9, 2021 ` },
        { text2: ` Mike Meldman is one of the most influentional real-estate moguls in the country, which became irresistable to the rich and famous during the pandemic `, author2: ` Business Insider | June 4, 2021 ` },
        { text3: ` There's a real buy-in for resort communities offering amusement and amenities `, author3: ` Luxury Magazine | Spring/Summer, 2021 ` },
        { text4: ` This Blue chip Caribbean Island Hopes to Dethrone St. Barts `, author4: ` New York Post | April 5, 2021 ` }
        ],
